...
//    public static final String API_KEY = "AIzaSyD-vPRV7YdaMQD3bL2j_2rR4yI_H1QvBxk";
...
//            url = new URL(fullURL);
    ...
    public static String getJson(URL url) throws IOException {
        ...
        try {
            ...
            scanner.useDelimiter("\\A"); /*\\A is a regex meaning read everything*/
        ...
        try {
            ...
            for (int i = 0; i < numberOfBooks; i++) {
                ...
                Book book = new Book(bookJSON.getString(ID), volumeInfoJSON.getString(TITLE),
                        ...
                        volumeInfoJSON.getString(PUBLISHER), volumeInfoJSON.getString(PUBLISHED_DATE));
                books.add(book);
